...
import os, numpy as np, pandas as pd, sys; sys.path.insert(0, "/home/claude/fpl")
...
cal_cs = calibrate_cold_start(hist_csv="/tmp/coldstart_hist.csv")
...
def build_frame(depth: bool):
    ...
    if depth:
        ...
        pl = sp.apply_minutes_shrinkage(pl, cal_own, k_min=900)  # then evidence-weighted minutes
...
final.round(2).to_csv("/mnt/user-data/outputs/decision_gw1_6_depthprior.csv", index=False)
print("\n" + "=" * 74)
